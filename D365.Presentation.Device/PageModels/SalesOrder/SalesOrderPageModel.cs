...
public partial class SalesOrderPageModel(ConnectivityService connectivityService, SessionService sessionService, IViewConfirmedSalesOrdersUseCase uc)
    : AbstractPageModel(connectivityService, sessionService)
{
    ...
    private async Task OpenDetailsAsync(D365SalesOrderHeaderRecord so)
    {
        ...
        await Shell.Current.GoToAsync($"{nameof(SalesOrderDetailPage)}");
    ...
    private async Task<D365SalesOrderHeaderRecord[]> LoadAsync(bool isOnline = false)
    {
